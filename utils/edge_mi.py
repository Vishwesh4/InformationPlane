# EDGE Estimator for Shannon Mutual Information, taken from https://github.com/mrtnoshad/EDGE/tree/master/information_plane
#
...
# Fully Dependent Datasets
	...
	Y = 2*X+0.001*np.random.rand(5000,1000)
	...
	I = EDGE(X,Y,U=50,epsilon=[0.2,0.2],L_ensemble=10,epsilon_vector="range",gamma=[1,1])
